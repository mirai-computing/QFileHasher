...
/**
   ...
   @return CRYPT_OK if successful
*/
HASH_PROCESS(ltc_rmd128_process, rmd128_compress, rmd128, 64)
...
/**
   ...
   @return CRYPT_OK if successful
*/
int ltc_rmd128_done(hash_state * md, unsigned char *out)
{
    int i;
...
int ltc_rmd128_test(void)
{
   ...
   for (x = 0; x < (int)(sizeof(tests)/sizeof(tests[0])); x++) {
       ltc_rmd128_init(&md);
       ltc_rmd128_process(&md, (unsigned char *)tests[x].msg, strlen(tests[x].msg));

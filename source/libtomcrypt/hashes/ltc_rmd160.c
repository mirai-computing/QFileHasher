...
/**
   ...
   @return CRYPT_OK if successful
*/
HASH_PROCESS(ltc_rmd160_process, rmd160_compress, rmd160, 64)
...
/**
   ...
   @return CRYPT_OK if successful
*/
int ltc_rmd160_done(hash_state * md, unsigned char *out)
{
    int i;
...
int ltc_rmd160_test(void)
{
   ...
   for (x = 0; x < (int)(sizeof(tests)/sizeof(tests[0])); x++) {
       ltc_rmd160_init(&md);
       ltc_rmd160_process(&md, (unsigned char *)tests[x].msg, strlen(tests[x].msg));

...
/**
   ...
   @return CRYPT_OK if successful
*/
HASH_PROCESS(ltc_rmd256_process, rmd256_compress, rmd256, 64)
...
/**
   ...
   @return CRYPT_OK if successful
*/
int ltc_rmd256_done(hash_state * md, unsigned char *out)
{
    int i;
...
int ltc_rmd256_test(void)
{
   ...
   for (x = 0; x < (int)(sizeof(tests)/sizeof(tests[0])); x++) {
       ltc_rmd256_init(&md);
       ltc_rmd256_process(&md, (unsigned char *)tests[x].msg, strlen(tests[x].msg));

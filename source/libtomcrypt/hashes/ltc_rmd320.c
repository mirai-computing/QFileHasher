...
/**
   ...
   @return CRYPT_OK if successful
*/
HASH_PROCESS(ltc_rmd320_process, rmd320_compress, rmd320, 64)
...
/**
   ...
   @return CRYPT_OK if successful
*/
int ltc_rmd320_done(hash_state * md, unsigned char *out)
{
    int i;
...
int ltc_rmd320_test(void)
{
   ...
   for (x = 0; x < (int)(sizeof(tests)/sizeof(tests[0])); x++) {
       ltc_rmd320_init(&md);
       ltc_rmd320_process(&md, (unsigned char *)tests[x].msg, strlen(tests[x].msg));

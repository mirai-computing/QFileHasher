...
/**
   ...
   @return CRYPT_OK if successful
*/
HASH_PROCESS(ltc_whirlpool_process, whirlpool_compress, whirlpool, 64)
...
/**
   ...
   @return CRYPT_OK if successful
*/
int ltc_whirlpool_done(hash_state * md, unsigned char *out)
{
    int i;
   ...
   /* 512-bits, leading set of last byte */
{
  ...
  for (i = 0; i < (int)(sizeof(tests)/sizeof(tests[0])); i++) {
      ltc_whirlpool_init(&md);
      ltc_whirlpool_process(&md, (unsigned char *)tests[i].msg, tests[i].len);
      ltc_whirlpool_done(&md, tmp);
